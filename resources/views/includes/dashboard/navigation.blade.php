<nav
      ...
      <div
        ...
        <a class="md:block text-left md:pb-1 text-blueGray-700 mr-0 inline-block whitespace-nowrap text-lg font-bold px-0"
          href="../../index.html">
        ...
        <div
          ...
          <div class="md:min-w-full md:hidden block pb-4 mb-4 border-b border-solid border-blueGray-200">
            <div class="flex flex-wrap">
              <div class="w-6/12">
                <a class="md:block text-left md:pb-2 text-blueGray-600 mr-0 inline-block whitespace-nowrap text-sm  font-bold p-4 px-0"
                  href="../../index.html">
                  Notus JS
                </a>
              </div>
